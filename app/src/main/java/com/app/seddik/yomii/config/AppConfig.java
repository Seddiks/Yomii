...
public class AppConfig {
    ...
    public static String URL_FORGET_PASSWORD = "http://192.168.1.6:81/Yomii/auth/";
    //  public static String URL_REGISTER = "http://yomii.alwaysdata.net/android_login_api/register.php";
    //Upload photos to server
    public static String URL_UPLOAD_PHOTOS = "http://192.168.1.6:81/Yomii/profil/";
    //Home page
    public static String URL_UPLOAD_DATA_HOME = "http://192.168.1.6:81/Yomii/home/";

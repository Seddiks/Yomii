...
/**
 * Created by Seddik on 08/05/2018.
 */

public class LocalStorageProvider extends DocumentsProvider {

    public static final String AUTHORITY = "com.app.seddik.yomii";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_camera);

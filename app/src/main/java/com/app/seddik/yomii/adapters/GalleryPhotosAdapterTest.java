...
public class GalleryPhotosAdapterTest extends RecyclerView.Adapter<GalleryPhotosAdapterTest.ViewHolder> {
    ...
    public GalleryPhotosAdapterTest(Context context, ArrayList<GalleryPhotosItems> galleryList) {
        this.galleryList = galleryList;
        this.context = context;
    }

    @Override
    public GalleryPhotosAdapterTest.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.gallery_photos_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(GalleryPhotosAdapterTest.ViewHolder viewHolder, final int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            img_multiple = view.findViewById(R.id.icon_gallery);
        }
    }

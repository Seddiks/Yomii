package com.app.seddik.yomii.utils.filter;
...
/**
 * Created by Seddik on 12/01/2018.
 */
...
//
    ...
    public enum FilterType {GaussianBlur,Bilateral,Swirl,Temperature,
    ...
    public static class FilterAdjuster {
        ...
        public FilterAdjuster(final GPUImageFilter filter) {
            if (filter instanceof GPUImageSharpenFilter) {
                ...
                adjuster = new TemperatureAdjuster().filter(filter);
            }
        ...
        private class GammaAdjuster extends Adjuster<GPUImageGammaFilter> {
            @Override
            public void adjust(final int percentage) {
                getFilter().setGamma(range(percentage, 0.0f, 2.0f));
            }
        }
        ...
        private class TemperatureAdjuster extends Adjuster<GPUImageWhiteBalanceFilter> {
            @Override
            public void adjust(final int percentage) {
                getFilter().setTemperature(range(percentage, 4500.0f, 5500.0f));
            }
        }
        ...
        private class VignetteAdjuster extends Adjuster<GPUImageVignetteFilter> {
            @Override
            public void adjust(final int percentage) {
                getFilter().setVignetteStart(range(percentage, 0.75f, 0.5f));
            }
        }

 ...
 */
public class UserAdapter extends PagedListAdapter<GalleryPhotosItems, RecyclerView.ViewHolder> {

    private static DiffUtil.ItemCallback<GalleryPhotosItems> UserDiffCallback = new DiffUtil.ItemCallback<GalleryPhotosItems>() {
        @Override
